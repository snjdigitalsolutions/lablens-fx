...
public class ListFilesTask extends Task<Void> {
    ...
    protected Void call() throws Exception {
        ...
        List<FileSystemObject> databasedFiles = configurationPath.getComputeResource().getFileSystemObjects();
        databasedFiles.forEach(file -> {
            if (fileNameToModelMap.containsKey(file.getFileName()) && file.getParentPath().equalsIgnoreCase(configurationPath.getConfigurationPath())){
